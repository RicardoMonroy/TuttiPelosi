            ...
            <div class="wp_form">
                <form role="form" method="POST" action="{{ route('login') }}">
                    @csrf
                        ...
                        <h1 class="titleCard">BIENVENIDO</h1>
                        <div class="wp_showData">
                            ...
                            <input class="inputInfo" name="password" type="password" placeholder="CONTRASEÑA" required />
                        ...
                        <a href="{{ route('password.request') }}" class="btn btnPass">RECUPERAR CONTRASEÑA</a>
                        <a href="{{ route('register') }}" class="btn btnNew">NUEVO USUARIO</a>
                        <button type="submit" class="btn btnNext">SIGUIENTE</button>
                </form>
            </div>
        </div>
    </div>
